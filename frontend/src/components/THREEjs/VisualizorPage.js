...
export class VisualizorPage extends BaseComponent {
  ...
  #initializeParticleSystem() {
    import("https://cdn.skypack.dev/three@0.136.0").then((THREE) => {
      import(
        "https://cdn.skypack.dev/three@0.136.0/examples/jsm/libs/stats.module.js"
      ).then((Stats) => {
        import(
          "https://cdn.skypack.dev/three@0.136.0/examples/jsm/libs/lil-gui.module.min.js"
        ).then((GUI) => {
          import(
            ...
            function init() {
              ...
              positions = new Float32Array(
                maxParticleCount * maxParticleCount * 3,
              );
